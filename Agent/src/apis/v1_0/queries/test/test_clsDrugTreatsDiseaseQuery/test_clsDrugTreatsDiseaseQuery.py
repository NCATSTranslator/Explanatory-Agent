...
class test_clsDrugTreatsDiseaseQuery(unittest.TestCase):
    ...
    def test_user_request_body_is_supported(self):
        query = clsDrugTreatsDiseaseQuery(userRequestBody=self.loadJsonFromFile("test_user_request_body_nominal.json"))
        result = query.userRequestBodyIsSupported()
        self.assertEqual(True, result)

    def test_user_request_body_not_supported(self):
        query = clsDrugTreatsDiseaseQuery(userRequestBody=self.loadJsonFromFile("test_user_request_body_not_supported.json", directoryAlias="common"))
        result = query.userRequestBodyIsSupported()
