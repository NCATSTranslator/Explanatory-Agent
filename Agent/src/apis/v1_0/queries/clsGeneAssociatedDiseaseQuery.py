...
class clsGeneAssociatedDiseaseQuery(clsQuery):
    """
    See header
    """
    ...
    def getDataFromKnowledgeProviders(self):
        ...
        self.connectionHypothesisKnowledgeProvider.buildRequestBody(diseaseId=diseaseId, hasGeneNode=True, hasSurvivalNode=False)
