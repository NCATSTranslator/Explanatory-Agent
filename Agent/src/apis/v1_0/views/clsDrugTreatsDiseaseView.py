...
class DrugTreatsDiseaseView(DiseaseAssociatedGeneView):
    @staticmethod
    def predicates():
        return {
            "biolink:Drug": {
    ...
    def supports_query(self, trapi_query):
        ...
        geneId = None
        diseaseId = None
        # validCuries = DrugTreatsDiseaseView.get_valid_curies()
    ...
    def retrieve(self):
        ...
        chp_query = ConnectionsHypothesisProvider.build_chp_query(disease_id, drug_node=True, survival_node=False)
