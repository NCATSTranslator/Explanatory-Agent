"""
Assign "The score was obtained based on the existence of publications as informed by MyDisease-Info"
...
Assign:
{
  ...
  "value":  "This result was given a score of 1 because the MyDisease-Info knowledge provider producing this result has indicated a publication in its support",
...
class ExplanationX00016(clsExplanationBase):
            ...
            result['attributes'] = [
                {
                    ...
                    "value": "The score was obtained based on the existence of publications as informed by MyDisease-Info",
    ...
    def edgeAttributeValidate(self, edge):
        """
        Criteria 1: "attribute_type_id": "biolink:aggregator_knowledge_source" AND "value" = "infores:mydisease-info"
        Criteria 2: "attribute_type_id": "biolink:publications" AND "value" : NOT EMPTY
        """
        criteria_1_met = False
        criteria_2_met = False
        for attribute in edge["attributes"]:
            if attribute['attribute_type_id'] == 'biolink:aggregator_knowledge_source' and self.attribute_has_value(attribute['value'], 'infores:mydisease-info'):
                criteria_1_met = True
...
if __name__ == "__main__":
    x = ExplanationX00016("awesome_kp")
