...
class BioBERTi2b2Processor(DataProcessor):
  """Processor for the BioBERT data set (GLUE version)."""
  ...
  def get_labels(self):
    """See base class."""
    return ["TrIP", "TrWP", "TrCP", "TrAP", "TrNAP", "TeRP", "TeCP", "PIP"]
...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    file_based_convert_examples_to_features(predict_examples, label_list,
                                            ...
                                            predict_file)
    for example in tf.python_io.tf_record_iterator(predict_file):
